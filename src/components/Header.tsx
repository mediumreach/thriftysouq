        ...
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center space-x-12">
            <button
              ...
              className="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 tracking-tight"
            >
              ThriftySouq
            </button>
            ...
            <form onSubmit={handleSearch} className="w-full">
              <div className="relative group">
                <input
                  ...
                  className="w-full px-4 py-2.5 pl-11 pr-4 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent focus:bg-white transition-all duration-200"
                />
          ...
          <div className="flex items-center space-x-4">
            <select
              ...
              className="bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 hover:bg-gray-100 transition-colors cursor-pointer"
            >
              {currencies.map(curr => (
            ...
            <form onSubmit={handleSearch} className="mb-4">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 pl-10 pr-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900"
                />
